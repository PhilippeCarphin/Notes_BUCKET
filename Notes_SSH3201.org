...
*** Cours 5 Conversion de taux d'intérêts 
...
On appelle CM_u = PV - CV_u la *contribution marginale unitaire*.

La contribution *marginale en pourcentage* est définie par CM_% = CM_u / PV_u

Finalement la *contribution marginale totale* est définie par

 CM_$(U) = Ventes - Coûts Variables Totaux = PV_u * U - CV_u * U 
...
*** Cours 8 Métriques de comparaison (AE, CAE, RC, DUE)
*** Cours 9,10 : Impôt
*** Cours 11,12 : Risque
** Don't forget:
